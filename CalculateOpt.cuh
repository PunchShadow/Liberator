...
#endif
#ifdef CACHE_STAT
void newcc_opt(string path, double adviseRate,int model,int testTimes, double gpuMemoryLimit = 0.0, bool verify = false, string cacheCsv = "", string pathCsv = "", string cacheStatCsv = "", int cacheStatRunId = 0);
#else
...
#endif
#ifdef CACHE_STAT
void newpr_opt(string path, double adviseRate,int model,int testTimes, double gpuMemoryLimit = 0.0, bool verify = false, string cacheCsv = "", string pathCsv = "", string cacheStatCsv = "", int cacheStatRunId = 0);
#else
